...
public class TwizoCallable implements Callable<String> {
  ...
  public TwizoCallable(String host, String apiKey, String functionUrl, String params,
      RequestType requestType) throws TwizoException {
   ...
   */
  @Override
  public String call() throws TwizoException {
    try {
      switch (requestType) {
        case GET:
          return sendGet();
   ...
   */
  private String sendGet() throws IOException, TwizoException {
    connection.setRequestMethod(requestType.toString());

    if (connection.getResponseCode() == 200) {
      return processOutput(false);
    } else {
      throw new TwizoException(String
          .format("The server responded with status code: %d", connection.getResponseCode()));
    }
  }
   ...
   */
  private String sendPost() throws IOException, TwizoException {
    ...
    if (this.params != null) {
      ...
      if (connection.getResponseCode() == 201) {
        ...
        throw new TwizoException(String.format("The server responded with code: %d%nMessage:%n %s",
   ...
   */
  private String sendPut() throws IOException, TwizoException {
   ...
   */
  private void sendDelete() throws IOException, TwizoException {
