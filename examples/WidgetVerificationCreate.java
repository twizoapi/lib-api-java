 ...
 */
public class WidgetVerificationCreate extends AbstractExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // an object
            System.out.println(verificationController.createWidgetSession(params));
        } catch (TwizoCallException | TwizoJsonParseException | IOException | WidgetException e) {
            Logger.getLogger(WidgetVerificationCreate.class.getName()).log(Level.SEVERE, e.getMessage(), e);
        }
    }
}
